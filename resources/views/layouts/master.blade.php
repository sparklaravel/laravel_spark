    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-3 logo-block">
                <img class="logo-img" src="{{ asset('assets/img/icons/logo.svg') }}" alt="POLLHOLE Logo">
            ...
            <div class="col-9 d-lg-none d-flex justify-content-end">
                <div class="mobile-menu">
                    <img onclick="openNav()" src="{{ asset('assets/img/icons/menu-primary.svg') }}" alt="">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="logo-block">
                    <img src="{{ asset('assets/img/icons/logo.svg')}}" alt="POLLHOLE Logo">
                    <span class="logo-text">Pollhole</span>
                </div>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8 d-flex justify-content-lg-end justify-content-start justify-content-xl-end justify-content-md-end">
                ...
                <div class="footer-social">
                    ...
                    <ul>
                        <li>
                            <a href="#"><img src="{{ asset('assets/img/icons/twitter-footer.svg')}}" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{ asset('assets/img/icons/facebook-footer.svg')}}" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{ asset('assets/img/icons/google-plus-footer.svg')}}" alt=""></a>
                        </li>
                        <li>
                            <a href="#"><img src="{{ asset('assets/img/icons/tumblr-footer.svg')}}" alt=""></a>
                        </li>
                    </ul>
                    <a href="#">
